...
export function summarize(records, days, usdPerMTok = 0.042) {
    ...
    const decisivelyRecoverable = restorableKnown.filter(c => c.band !== 'allow' && (c.restorable ?? 1) < 0.5);
    // A block the second question relaxes to an escalation, or a revise relaxed to allow.
